...
function enemy_attacks_town(game) {
    ...
    defender_player.fortification = game.data.fortification || 0;

    var battle = {};

    var attack_from_town = _c.randOption([false, true, true], game.game_options);
    if (attack_from_town) {
        ...
        var attacker = _c.build_enemy_force_from_land_name(game, attacker_land, false);

        battle = {player_state: 'defender', in_progress: true, started: game.data.tick_count, defender: defender_player, attacker: attacker, options: {}, func_finish: battle_ended, tie_after_ticks: 20};
        ...
        //Attack comes from a military force
        console.log('TODO: Attack from a roving enemy');
        return;
    }
