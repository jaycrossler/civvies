...
//  {name:"deityType"},
    ...
    new Civvies('add_game_option', 'achievements', {name: "fields", category: "deity"});
    new Civvies('add_game_option', 'achievements', {name: "underworld", category: "deity"});
    new Civvies('add_game_option', 'achievements', {name: "fullHouse", title: "Full House", category: "deity"});
